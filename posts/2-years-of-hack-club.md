...
![An interaction between me and Zach Latta, where he puts the Arcade YubiKey on sale upon my request](images/zach-latta-yubikey-sale.png)
...
<img src="images/rough-sketches-jaime.png" alt="A screenshot from my sketchbook visual novel, Rough Sketches, featuring dialogue with a character named Jaime" style="max-width: 750px;" />
...
![An interaction between me and other Hack Clubbers, discussing the time remaining until application results come out](images/internship-impatience.png)
